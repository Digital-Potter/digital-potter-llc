...
const callouts = [
	{
		...
		body: "A one-time build covers design, development, content migration, accessibility, performance tuning, and launch. Final scope and price land in your proposal after a discovery week — but $3,500 is where most marketing sites start, and that's a fixed budget, not an hourly meter.",
	},
	{
		tag: '02 — Run',
