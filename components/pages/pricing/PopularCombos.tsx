...
export default function PopularCombos() {
	return (
		<section className="dp-container py-16 md:py-24">
				...
				{POPULAR_COMBOS.map((combo) => {
					...
					return (
						...
						>
							...
							<p className="text-dp-body/80 mt-3 text-base md:text-lg">
								{combo.scenario}
							</p>
							<div className="border-dp-dark/10 mt-6 flex items-end justify-between border-t pt-6">
								<div>
									<p className="text-dp-body/60 text-xs font-bold tracking-wider uppercase">
										Plan
									</p>
								...
								<p className="font-primary-font text-dp-dark-green text-2xl font-bold md:text-3xl">
									${monthly}
									<span className="text-dp-body/60 ml-1 text-sm font-medium">
										/mo
									</span>
								</p>
							</div>
			...
			<p className="text-dp-body/70 mt-8 text-center text-sm">
